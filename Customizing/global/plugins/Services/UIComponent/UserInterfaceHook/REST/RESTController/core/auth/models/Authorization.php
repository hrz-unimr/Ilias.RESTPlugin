 ...
 * Used by the authorization code grant type and implicit grant type flow.
 * https://tools.ietf.org/html/rfc6749#section-3.1 - Authorization Endpoint
 *
 * api_key
 * response_type
 * redirect_uri
...
class Authorization extends Base {
  ...
  public static function allGrantTypes($api_key, $redirect_uri, $username, $password, $response_type, $authenticityToken) {
    // Check input (code = authorization-code / token = access-token)
  ...
  protected static function manageCredentials() {
  ...
  protected static function manageAuthorization() {
