...
/**
 * Class: RESTKey2User (Database-Table)
 *  Abstraction for 'ui_uihk_rest_key2user' database table.
 *  See RESTDatabase class for additional information.
 */
class RESTKey2User extends Libs\RESTDatabase {
  // This three variables contain information about the table layout
  protected static $primaryKey  = 'id';
  protected static $tableName   = 'ui_uihk_rest_key2user';
