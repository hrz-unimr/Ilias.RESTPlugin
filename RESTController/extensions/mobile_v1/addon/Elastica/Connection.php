...
class Connection extends Param
{
    ...
    {
        return $this->hasParam('port') ? $this->getParameter('port') : self::DEFAULT_PORT;
    }
    ...
    {
        return $this->hasParam('host') ? $this->getParameter('host') : self::DEFAULT_HOST;
    }
    ...
    {
        return $this->hasParam('proxy') ? $this->getParameter('proxy') : null;
    }
    ...
    {
        return $this->hasParam('transport') ? $this->getParameter('transport') : self::DEFAULT_TRANSPORT;
    }
    ...
    {
        return $this->hasParam('path') ? $this->getParameter('path') : '';
    }
    ...
    {
        return (int) $this->hasParam('timeout') ? $this->getParameter('timeout') : self::TIMEOUT;
    }
    ...
    {
        return (bool) $this->hasParam('persistent') ? $this->getParameter('persistent') : true;
    }
