...
class Result
{
    ...
    {
        return $this->getParameter('_score');
    }
    ...
    {
        return $this->getParameter('_source');
    }
    ...
    {
        return $this->getParameter('highlight');
    }
    ...
    {
        return $this->getParameter('_explanation');
    }
