...
class AbstractUpdateAction extends Param
{
    ...
    {
        return ($this->hasParam('_id')) ? $this->getParameter('_id') : null;
    }
    ...
    {
        return $this->getParameter('_type');
    }
    ...
    {
        return $this->getParameter('_index');
    }
    ...
    {
        return $this->getParameter('_version');
    }
    ...
    {
        return $this->getParameter('_version_type');
    }
    ...
    {
        return $this->getParameter('_parent');
    }
    ...
    {
        return $this->getParameter('_op_type');
    }
    ...
    {
        return $this->getParameter('_percolate');
    }
    ...
    {
        return $this->getParameter('_routing');
    }
    ...
    {
        return $this->getParameter('_fields');
    }
    ...
    {
        return $this->getParameter('_retry_on_conflict');
    }
    ...
    {
        return $this->getParameter('_timestamp');
    }
    ...
    {
        return $this->getParameter('_refresh');
    }
    ...
    {
        return $this->getParameter('_timeout');
    }
    ...
    {
        return $this->getParameter('_consistency');
    }
    ...
    {
        return $this->getParameter('_replication');
    }
    ...
    public function getOptions(array $fields = array(), $withUnderscore = false)
    {
        if (!empty($fields)) {
            ...
            foreach ($fields as $field) {
                $key = '_'.ltrim($field, '_');
                if ($this->hasParam($key) && '' !== (string) $this->getParameter($key)) {
