...
class Filtered extends AbstractQuery
{
    ...
    public function toArray()
    {
        ...
        if ($this->hasParam('query') && $this->getParameter('query') instanceof AbstractQuery) {
            $filtered['query'] = $this->getParameter('query')->toArray();
        }

        if ($this->hasParam('filter') && $this->getParameter('filter') instanceof AbstractFilter) {
            $filtered['filter'] = $this->getParameter('filter')->toArray();
        }
